    ...
    >
      <View style={styles.header}>
        <View style={styles.avatar}>
          <Image
            source={{ uri: application?.img || dummyImageUrl }}
            style={styles.avatarImage}
          />
        </View>

        <View style={styles.info}>
          <Text style={styles.name}>{application?.name || "N/A"}</Text>
          <Text style={styles.company}>{application?.branch || "N/A"}</Text>
        </View>
      </View>
      ...
      <View style={styles.actionsRow}>
        <View style={styles.actionButton}>
          ...
          <Text style={styles.actionText}>{application?.status || "N/A"}</Text>
        </View>
        <View style={styles.actionButton}>
          <Ionicons name="flag-outline" size={12} color={colors.primary} />
          <Text style={styles.actionText}>{application?.country || "N/A"}</Text>
        </View>
      </View>
      ...
      >
        <Text style={styles.footerText}>
          Added on {application?.createdAt || "N/A"}
        </Text>
        <Ionicons
