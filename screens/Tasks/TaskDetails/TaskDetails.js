...
export default function TaskDetails({ route }) {
  ...
  const statusSelected = toOptionValue(leadStatuses, editable?.status);
  ...
  return (
    ...
    >
      ...
      <View style={[styles.card, { zIndex: 9000 }]}>
        ...
        <Selector
          ...
          onValueChange={(val) => {
            ...
            setEditable((p) => ({ ...p, status: opt?.label || val }));
          }}
        ...
        <Selector
          ...
          onValueChange={(val) => {
            ...
            setEditable((p) => ({ ...p, substatus: opt?.label || val }));
          }}
      ...
      <View style={styles.card}>
        <View style={styles.cardHeaderRow}>
          <Text style={styles.cardTitle}>Task Contact</Text>
          {!isEditingContact ? (
            <TouchableOpacity
      ...
      <View>
        ...
        >
          ...
          <View style={styles.ctaTextWrap}>
            ...
            <Text style={styles.ctaSubtitle}>Open task conversation</Text>
          </View>
