...
import { countries, branches, districts } from "../../constants/dropdownData";
...
export default function AddStudent() {
  ...
  const validateForm = () => {
    if (!formData.name.trim())
      return Alert.alert("Error", "Please enter the student's name") || false;
    if (!formData.phone.trim())
      return Alert.alert("Error", "Please enter the phone number") || false;
    return true;
  };
...
const styles = StyleSheet.create({
  ...
  fileDetails: { flex: 1, marginRight: 12 },
  fileName: {
    fontSize: 14,
    fontWeight: "600",
    color: colors.primaryText,
  ...
  fileSize: { fontSize: 12, color: colors.secondaryText },
  removeButton: {
    width: 36,
    height: 36,
    borderRadius: 18,
